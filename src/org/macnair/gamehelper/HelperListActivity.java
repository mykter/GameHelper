...
/**
 * An activity representing a list of Helpers. This activity has different
 * presentations for handset and tablet-size devices. On handsets, the activity
 * presents a list of items, which when touched, lead to a
 * {@link HelperDetailActivity} representing item details. On tablets, the
...
public class HelperListActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.helper_detail_container) != null) {
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			Intent detailIntent = new Intent(this, HelperDetailActivity.class);
			detailIntent.putExtra(HelperDetailFragment.ARG_ITEM_ID, id);
